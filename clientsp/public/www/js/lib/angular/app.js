          ...
          $stateProvider.state('dashboard', 
        {
           ...
           ,views:{
              ...
              {                
                ...
                template : heaerieUssServiceProvider.GenHtmlTemplateFromSJson('basicDet','N',"EDIT") //EIDT and ADD
